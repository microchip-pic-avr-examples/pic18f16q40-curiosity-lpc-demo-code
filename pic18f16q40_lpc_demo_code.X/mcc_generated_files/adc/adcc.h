...
/**
 * @ingroup adc_with_computation
 * @brief Setter for threshold interrupt.
 * @param[in] InterruptHandler - Pointer to custom ISR.
 * @return void
 *
 * @details <b>API usage example</b>
 * @code
 * void customADTInterruptHandler(void)
 * {
 *    //Custom ISR code
 * }
 *
 ...
 * {
 *     ADCC_Initialize();
 *     ADCC_SetADTIInterruptHandler(customADTInterruptHandler);
 *     ADCC_StartConversion(channel_ANA0);
 *
 *     //Replace with your application code
 *     while(1)
...
/**
 * @ingroup adc_with_computation
 * @brief Interrupt Service Routine for threshold interrupt.
 * @param void
 * @return void
 */
